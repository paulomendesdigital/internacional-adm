...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Deletar Usuário </h2>
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{route('users.index')}}" class="btn btn-primary mr-3 float-left"><i class="fas fa-arrow-left"></i> Cancelar</a>
                <form class="float-left" method="post" action="{{route('users.destroy', $user->id)}}" enctype="multipart/form-data">
                    {!! method_field('DELETE') !!}
                    {!! csrf_field() !!}
