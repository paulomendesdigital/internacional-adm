...
<head>
    ...
    <title>E-mail de Plano do Client</title>
...
<body>
    <div class="container" style="margin-top: 50px">
        <div class="row">
            <div class="col-md-12">
                <h1>E-mail de Plano do Cliente</h1>

                <br>

                <p>
                    <b>{{ $dataClient['name'] }}</b>: {{ $dataClient['email'] }} <br>
                ...
                <p>
                    <a href="{{ url('/panel/clients/view', $dataClient['id']) }}" class="btn btn-primary">Cliente</a>
                    <br>
                    <br>
                    <a href="{{ url('/planos/visualizar', base64_encode($dataClient['id']) ) }}" class="btn btn-primary">Planos para o Cliente</a>
                </p>
            </div>
        </div>
    </div>
